...
public abstract class MixinWorldServerCommon extends World implements TiqualityWorld {
     ...
     */
    public @Nonnull
    TiqualityChunk getTiqualityChunk(BlockPos pos) {
        return MixinConfigPlugin.spongePresent ? SpongeChunkLoader.getChunkForced(this, new ChunkPos(pos)) : (TiqualityChunk) this.getChunk(pos);
    }
