...
import orf.objectweb.asm.tree.ClassNode;
...
public class MixinConfigPlugin implements IMixinConfigPlugin {
    ...
    private boolean shouldApplyMixin(String mixin) {
        if (spongePresent == true) {
            ...
            switch (mixin) {
                //case "com.github.terminatornl.tiquality.mixin.MixinSpongeTrackingUtil":
                //case "com.github.terminatornl.tiquality.mixin.MixinSpongePhaseTracker":
